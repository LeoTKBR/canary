...
void ConfigFunctions::init(lua_State* L) {
	...
	registerEnumIn(L, "configKeys", ALLOW_DUAL_WIELDING)
	registerEnumIn(L, "configKeys", DUAL_WIELDING_SPEED_RATE)
	registerEnumIn(L, "configKeys", DUAL_WIELDING_DAMAGE_RATE)
